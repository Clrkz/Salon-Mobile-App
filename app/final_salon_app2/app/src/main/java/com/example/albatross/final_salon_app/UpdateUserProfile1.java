...
public class UpdateUserProfile1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_update_users1, container, false);
        ...
        img_profile.setOnClickListener(new View.OnClickListener() {
            ...
            if (!addUsersHandler.ImageName.equals("")) {
               // loadProfile(addUsersHandler.ImageName);
                Glide.with(getActivity()).load(Server.URL + "images/" + addUsersHandler.ImageName).into(img_profile);
            }
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(et_firstname.getText())) {
                    ...
                    if (abs2 == 1) {
                        ...
                        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new UpdateUserProfileNext1()).commit();
                    }
