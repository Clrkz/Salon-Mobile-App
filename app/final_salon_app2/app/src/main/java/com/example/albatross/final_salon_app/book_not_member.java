...
public class book_not_member<et_time> extends Fragment {
...
TextView tvfhr,tvthr,tvcdate;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =  inflater.inflate(R.layout.fragment_book_not_member, container, false);
 ...
 if(Bookhandler.price<100){
     btn_next.setText("Book");
 }else{
     btn_next.setText("Next");
        ...
        if(!Bookhandler.time.equals("")){
            et_time.setText(Bookhandler.time);
        }
        if(!Bookhandler.date.equals("")){
            et_date.setText(Bookhandler.date);
        }
...
if(et_date.getText().toString().equals("")){
    ...
    if (Bookhandler.price < 100) {
        ...
        String pdate = et_date.getText().toString();
        String ptime = et_time.getText().toString();
        Bookhandler.date = pdate;
        Bookhandler.time = ptime;
        getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new book_not_member_next()).commit();
    }
}
            }
        });
