...
public class fragment_nail_services extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_admin_nail_service, container, false);
        ...
        if (conMgr.getActiveNetworkInfo() != null
            ...
            adapter = new NailAdapter(getActivity(), services);
        ...
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... movieIds) {
                ...
                Request request = new Request.Builder()
                        .url(Server.URL + "service_nail.php" )
                        .build();
                Log.e("TAG", Server.URL + "service_nail.php" );
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        fragment_nail_services.this.services.add(services);
                    }
