...
public class update_customer_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_update_profile1, container, false);
        ...
        if (!uh.ImageName.equals("")) {
            Glide.with(getActivity()).load(Server.URL + "images/" + uh.ImageName).into(imgProfile);
        }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (abs != 1) {
                    ...
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                            new update_customer_next_fragment()).commit();
                } else {
