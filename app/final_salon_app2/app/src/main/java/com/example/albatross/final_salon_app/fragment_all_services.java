...
public class fragment_all_services extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_admin_all_service, container, false);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new fragment_add_service()).commit();
            }
        });
        ...
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... movieIds) {
                ...
                Request request = new Request.Builder()
                        .url(Server.URL + "service_list.php" )
                        .build();
                Log.e("TAG", Server.URL + "service_list.php" );
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        fragment_all_services.this.services.add(services);
                    }
