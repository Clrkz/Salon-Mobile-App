...
public class fragment_user_history extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (conMgr.getActiveNetworkInfo() != null
            ...
            adapter = new UserHistoryAdapter(getActivity(), services);
    ...
    private void getServicesFromDB(int id) {
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... movieIds) {
                ...
                String guest_id_PK = pref.getString("u_information_id_PK", null);

                OkHttpClient client = new OkHttpClient();
                Request request = new Request.Builder()
                        .url(Server.URL + "user_history.php?uid="+ UsersAdapter.uid)
                        .build();
                Log.e("TAG", Server.URL + "user_history.php?uid="+ UsersAdapter.uid);
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        fragment_user_history.this.services.add(services);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
