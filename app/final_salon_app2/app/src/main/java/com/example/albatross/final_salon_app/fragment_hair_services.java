...
public class fragment_hair_services extends Fragment {
    static List<Hair> services;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_admin_hair_service, container, false);
        ...
        if (conMgr.getActiveNetworkInfo() != null
            ...
            adapter = new HairAdapter(getActivity(), services);
        ...
        AsyncTask<Integer, Void, Void> asyncTask = new AsyncTask<Integer, Void, Void>() {
            ...
            protected Void doInBackground(Integer... movieIds) {
                ...
                Request request = new Request.Builder()
                        .url(Server.URL + "service_hair.php" )
                        .build();
                Log.e("TAG", Server.URL + "service_hair.php" );
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        fragment_hair_services.this.services.add(services);
                    }
