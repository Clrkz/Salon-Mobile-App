...
public class MyHistoryAdapter extends RecyclerView.Adapter<MyHistoryAdapter.ViewHolder> {
    ...
    public MyHistoryAdapter(Context context, List<History> services) {
    ...
    @Override
        ...
        if(services.get(position).getaccepted().equals("1")){
            holder.accept.setText("Accepted" );
        }else if(services.get(position).getaccepted().equals("2")){
            holder.accept.setText("Declined" );
        }else if(services.get(position).getaccepted().equals("0")){
            holder.accept.setText("Pending" );
        }else{
            holder.accept.setText("Pending" );
        }
        //Toast.makeText(context,(services.get(position).getaccepted()),Toast.LENGTH_SHORT).show();
    }
    @Override
    ...
    public MyHistoryAdapter(Context context, FragmentManager f_manager) {
        this.context = context;
